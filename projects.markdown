...
**Project 4.2: Power Management and Capping for Servers** The power consumption of servers can add up to mega Watts of power in a typical datacenter. Servers typically use multiple high-end CPUs and GPUs, causing the power per server to add up to more than 500-100W per server.  
